...
status: deprecated
testScope: e2e
linkedIds: ARCH-010,EPIC-001,FR-001,FR-002,FR-003,FR-004,FR-005,FR-006,FR-007,ADR-019,ADR-014,AUTH-010
created: 2026-08-27
---
...
Moved from `ARCH-010` (type `arch`) to this doc (`TP-002`, type `test-plan`) — test-plan content belongs under the `test-plan` type, not `arch`. `ARCH-010` is now a deprecated stub pointing here.
