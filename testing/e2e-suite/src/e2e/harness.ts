...
//
// Copy of services/ts/identity-service/src/e2e/harness.ts, adjusted only for
// this package's one-directory-deeper location (testing/e2e-suite/src/e2e vs
// services/ts/<name>/src/e2e) -- see that file's header for why this isn't
// shared as a library instead.
...
const TS_SERVICES_DIR = path.join(REPO_ROOT, "services/ts");
const GO_SERVICES_DIR = path.join(REPO_ROOT, "services/go");
